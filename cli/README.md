...
[Release Downloads](https://github.com/tsenart/migrate/releases)

```
$ curl -L https://github.com/tsenart/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
...
##### Unversioned
```
$ go get -tags 'postgres' -u github.com/tsenart/migrate/cmd/migrate
```

##### Versioned

```
$ go get -u -d github.com/tsenart/migrate/cmd/migrate
$ cd $GOPATH/src/github.com/tsenart/migrate/cmd/migrate
$ git checkout $TAG  # e.g. v4.1.0
$ go build -tags 'postgres' -ldflags="-X main.Version=$(git describe --tags)" -o $GOPATH/bin/migrate github.com/tsenart/migrate/cmd/migrate
```
...
1. Support for build constraints will be removed in the future: https://github.com/tsenart/migrate/issues/60
